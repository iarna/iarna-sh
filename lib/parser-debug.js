...
class DebugParser extends Parser {
  ...
  finish () {
    ...
    if (this.stack.length !== 0) {
      throw new Parser.GrammarError('All states did not return by end of stream')
    }
    return obj
  }
  callStack () {
  ...
  call (fn, returnWith) {
    ...
    this.ctx = null
    this.state = new Parser.State(fn)
  }
...
DebugParser.GrammarError = Parser.GrammarError
DebugParser.State = Parser.State
